...
![makeABaby accepting first and last name and returning a baby object having name and age properties](/function-accepting-first-last-name-with-returning-object.png)
